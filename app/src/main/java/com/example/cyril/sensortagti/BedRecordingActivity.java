 ...
 */
public class BedRecordingActivity extends Activity
{

    private final static String TAG = BedRecordingActivity.class.getSimpleName();
    // EXTRA.
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.bed_recording);
