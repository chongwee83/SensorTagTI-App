 ...
 */
public class BedTrainingActivity extends Activity
{

    private final static String TAG = BedTrainingActivity.class.getSimpleName();
    // EXTRA.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bed_training);
