 ...
 */
public class CouchRecordingActivity extends Activity
{

    private final static String TAG = CouchRecordingActivity.class.getSimpleName();
    // EXTRA.
    ...
    private void onCharacteristicChanged(String uuidStr,byte[] value)
    {
        ...
        else
        {
            ...
            if(this.luxometer.x>0)
                this.mState.setText("Empty "+this.luxometer.x+">0");
            else
                this.mState.setText("Full "+this.luxometer.x+"<=0");
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.couch_recording);
    ...
    CountDownTimer timer=new CountDownTimer(500,100)
    {
        ...
        public void onFinish()
        {
            ...
            if(X.get(5)<=0.0862)
            {
                mAction.setText("No action ("+X.get(5)+"<=0.0862)");
            }
            else
            {
                mAction.setText("In use ("+X.get(5)+">0.0862)");
            }
