...
public class DeviceScanActivity extends ListActivity
{
    ...
    private static final long SCAN_PERIOD = 3000; // Stops scanning after 3 seconds.
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        intent.putExtra(ChooserActivity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(ChooserActivity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if (mScanning)
        {
            //noinspection deprecation
            mBluetoothAdapter.stopLeScan(mLeScanCallback);
