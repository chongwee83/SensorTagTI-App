 ...
 */
public class DoorRecordingActivity extends Activity
{

    private final static String TAG = DoorRecordingActivity.class.getSimpleName();
    // EXTRA.
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED.equals(action))
            {
                ...
                s2=new LuxometerSensor(luxometerUuid,mBluetoothLeService,mDeviceAddress);
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.door_recording);
