 ...
 */
public class DoorTrainingActivity extends Activity
{

    private final static String TAG = DoorTrainingActivity.class.getSimpleName();
    // EXTRA.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.door_training);
