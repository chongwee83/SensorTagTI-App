 ...
 */
public class FridgeTrainingActivity extends Activity
{

    private final static String TAG = FridgeTrainingActivity.class.getSimpleName();
    // EXTRA.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fridge_training);
